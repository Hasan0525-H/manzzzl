...
| 3 | [phase-3](./phase-3-debug-experience.md) | 调试体验强化(截图/崩溃推送/DebugBridge) | 无 | ~1.5 周 | 🔵 进行中 | 代码完成·7 Task 全独立 commit·`:app`+`:build-engine` 测试全绿+`assembleDebug`·分支 `opt/phase-3-debug-experience`→PR to dev,待真机 7 项验证 | — |
